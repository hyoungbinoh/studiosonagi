        ...
        success: function (response) {
            ...
            for (let i = 0; i < samples.length; i++) {
                ...
                let temp_html = `<tr>
                                    ...
                                    <td><img class="admin-img" src="/static/${sampleImg1}"></td>
                                    ${sampleImg2 !== undefined ? 
                                        `<td><img class="admin-img" src="/static/${sampleImg2}"></td>` : 
                                        `<td><div class="admin-img"><div></td>`
                                    }
                                    ${sampleImg3 !== undefined ? 
                                        `<td><img class="admin-img" src="/static/${sampleImg3}"></td>` : 
                                        `<td><div class="admin-img"><div></td>`
                                    }
                                    ${sampleImg4 !== undefined ? 
                                        `<td><img class="admin-img" src="/static/${sampleImg4}"></td>` : 
                                        `<td><div class="admin-img"><div></td>`
                                    }
                                    ${sampleMovie !== '' ? 
                    ...
                    let temp_html = `<div>
                                        <a href="/sample/${sampleNum}">
                                            <div class="portfolio-img">
                                                <img src="/static/${sampleImg1}" alt="${sampleTitle}">
                                            </div>
                                            <p class="portfolio-text">${sampleTitle}<span class="portfolio-span">${sampleIcvfx && '(ICVFX 가능)'}</span></p>
                                        </a>
                                    </div>`
